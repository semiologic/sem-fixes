...
class sem_fixes
{
	...
	function init()
	{
		...
		if ( !is_admin() )
		{
			...
			add_filter('the_content', array('sem_fixes', 'add_thickbox'), 20);
			add_filter('the_excerpt', array('sem_fixes', 'add_thickbox'), 20);
		}
	} # init()
	...
	function add_thickbox($content)
	{
		$content = preg_replace_callback("/
			...
			<\s*\/\s*a\s*>
			/isx", array('sem_fixes', 'add_thickbox_callback'), $content);
